    ...
    <section className="about" id="about">
      <div className="wrap">
        <div className="fi about-inner" ref={ref}>
          ...
          <p className="stxt">
            Chúng tôi tin rằng ăn vặt lành mạnh phải gắn liền với sự bền vững. MAN-UP SNACK tiên phong biến vỏ xoài thành thực phẩm nhờ công nghệ Sấy lạnh, giúp giữ lượng dưỡng chất cao và hàm lượng chất xơ cao
          </p>
